...
<header class="bg-primary">
    <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid">
            <a class="navbar-brand text-light" href="index.jsp">Who's that pro?</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <div class="dropdown ms-3">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="filterDropdown">
                        ...
                        <li><a class="dropdown-item" href="valorant?show=North+America<%= sort %>">North America</a>
                        </li>
                    </ul>
                </div>
                <div class="dropdown ms-3">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="sortDropdown">
                        <li><a class="dropdown-item " href="valorant<%= show %>&sort=alphaAZ">Alphabetical (A to Z)</a>
                        </li>
                        <li><a class="dropdown-item " href="valorant<%= show %>&sort=alphaZA">Alphabetical (Z to A)</a>
                        </li>
                ...
                <button class="btn btn-secondary ms-3" type="button" onclick="window.location.href='add-player'">Add
                    Player
                </button>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-4 col-lg-4 col-xl-3">
            <div class="card mb-4" style="width: 18rem;">
                <img src="https://assets-prd.ignimgs.com/2021/12/21/valorant-1640045685890.jpg" class="card-img-top"
                     alt="<%= pro.getPlayer() %>" height="300" width="300">
                <div class="card-body">
                    <h5 class="card-title"><%= pro.getPlayer() %>
                    </h5>
                    <p class="card-text">Region: <%= pro.getRegion() %>
                        <br>Team: <%= pro.getTeam() %>
                    </p>
                    <button type="button" class="btn btn-primary btn-open" data-bs-toggle="modal"
                            data-bs-target="#valorantModal"
